...
//        LatLng lpru = new LatLng(18.234251, 99.487490);
//        mMap.addMarker(new MarkerOptions()
//                .position(lpru)
//                .title("Marker in LPRU")
//                .snippet("Lajabhat Lampang University")
////                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET))
//                .icon(BitmapDescriptorFactory.fromResource(R.drawable.markloca))
//        );
